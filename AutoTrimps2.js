var ATversion='Zek v4.3.0',atscript=document.getElementById('AutoTrimps-script'),basepath='https://NK85.github.io/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
...
function printChangelog() {
    ...
    var footer =
        ...
        <br>See <a target="#" href="https://github.com/NK85/AutoTrimps/blob/gh-pages/README.md">ReadMe</a> Or check <a target="#" href="https://github.com/NK85/AutoTrimps/commits/gh-pages" target="#">the commit history</a> (if you want).'
...
function mainLoop() {
    ...
    if (game.global.universe == 1){
		...
		if (game.global.spireActive && getPageSetting('SpireDeaths') <= game.global.spireDeaths) endSpire();
